...
public class ArrayValuePropertyDialog extends ValuePropertyDialog {
	...
	public ArrayValuePropertyDialog(String varName, String varTypeName, IJavaStackFrame stack, Shell shell, String initialValue, String extraMessage, DialogWorker worker) {
